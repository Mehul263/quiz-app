...
let questions = [
  ...
  {
    id:2,
    question: "Who's Thanos the son of?",
    options:[
      "Karen",
      "A'lars",
      "En Sabah Nur",
  ...
  {
    id:6,
    question: "Finish this line from Cpatain America: And Hulk, _______",
    options:[
      "Kick ass",
      "Smash",
      "Do it",
...
function next(){
  ...
  let user_answer = document.querySelector("li.option.active").textContent
